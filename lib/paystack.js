...
const Paystack = ({ paystackKey, metadata = {}, billingEmail, phone, lastName, firstName, amount = '0.00', plan = null, currency = 'NGN', channels = ['card'], refNumber, billingName, subaccount, handleWebViewMessage, onCancel, autoStart = false, onSuccess, activityIndicatorColor = 'green', }, ref) => {
