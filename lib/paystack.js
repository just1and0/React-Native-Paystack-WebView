...
const Paystack = ({ paystackKey, billingEmail, phone, lastName, firstName, amount = '0.00', currency = 'NGN', channels = ['card'], refNumber, billingName, metadata, subaccount, handleWebViewMessage, onCancel, autoStart = false, onSuccess, activityIndicatorColor = 'green', }, ref) => {
          ...
          <body  onload="payWithPaystack()" style="background-color:#fff;height:100vh">
            ...
            <script type="text/javascript">
              ...
              paystack.newTransaction({ 
                ...
                lastname: '${lastName}',
                phone: '${phone}',
                amount: ${(0, helper_1.getAmountValueInKobo)(amount)}, 
                currency: '${currency}',
