...
const Paystack: React.ForwardRefRenderFunction<React.ReactNode, PayStackProps> = (
  ...
  const subAccountString = subaccount ? `subaccount: '${subaccount}',` : ''; // should only send subaccount with the correct subaccount_code if you want to enable split payment on transaction
